...
/**
 * Defines the {@code MySlider} Sling Model used for the {@code hello-mak/components/content/-y--lider} component.
 * 
 */
@ConsumerType
public interface MySlider
    extends ComponentExporter
{
    ...
    com.adobe.cq.wcm.core.components.models.Image getImageTest();
