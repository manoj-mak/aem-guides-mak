...
import com.adobe.aem.guides.mak.core.models.MySlider;
...
}, resourceType = "hello-mak/components/content/-y--lider")
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class MySliderImpl
    implements MySlider
{
    ...
    private com.adobe.cq.wcm.core.components.models.Image imageTest;
    @ChildResourceFromRequest(injectionStrategy = InjectionStrategy.OPTIONAL)
    ...
    @Override
    public com.adobe.cq.wcm.core.components.models.Image getImageTest() {
        return imageTest;
    }
