...
/**
 * Defines the {@code MyBanner} Sling Model used for the {@code hello-mak/components/content/my-banner} component.
 * 
 */
@ConsumerType
    ...
    extends ComponentExporter
{
    ...
    String getActionButton1();

    String getActionButton2();

    com.adobe.cq.wcm.core.components.models.Image getPlanImage();

    com.adobe.cq.wcm.core.components.models.Image getBannerImage();
